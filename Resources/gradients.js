var currentColour = function() {
    var d = new Date();
    if (0 <= d.getHours() < 7) {  return 'rgb(196,201,211)'; }
    if (7 <= d.getHours() < 12) {  return 'rgb(104,102,113)'; }
    if (12 <= d.getHours() < 17) {  return 'rgb(103,103,113)'; }
    if (17 <= d.getHours() < 24) {  return 'rgb(196,201,211)'; }
};
...
var currentSettingsGradient = function() {
    return {
        type: 'linear',
        startPoint: { x: '50%', y: '100%' },
        endPoint: { x: '50%', y: '0%' },
...
var gradientStops ={
    ...
    "20:30" : [{ color: 'rgb(245,124,119)', offset: 0.18}, { color: 'rgb(153,63,123)', offset: 0.55 }, { color: 'rgb(57,23,83)', offset: 0.55 }],
